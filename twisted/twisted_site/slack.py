...
class SlackBot:
    ...
    def post_message(
        ...
        **kwargs: Any,
        ...
        return self.client.chat_postMessage(**payload)  # ty:ignore[invalid-argument-type] # pyright: ignore[reportArgumentType, reportCallIssue] # pyrefly: ignore[bad-argument-type]
